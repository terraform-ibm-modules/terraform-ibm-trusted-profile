...
| <a name="input_trusted_profile_links"></a> [trusted\_profile\_links](#input\_trusted\_profile\_links) | A list of Trusted Profile Link objects that are applied to the Trusted Profile created by the module. | <pre>list(object({<br/>    # required arguments<br/>    unique_identifier = string<br/>    cr_type           = string<br/>    links = list(object({<br/>      crn       = string<br/>      namespace = optional(string)<br/>      name      = optional(string)<br/>    }))<br/><br/>    # optional arguments<br/>    name = optional(string)<br/>  }))</pre> | `[]` | no |
